...
import image1 from '%/gallery/1.webp'
import image2 from '%/gallery/2.webp'
import image3 from '%/gallery/3.webp'
import image4 from '%/gallery/4.webp'
import image5 from '%/gallery/5.webp'
import image6 from '%/gallery/6.webp'
import image7 from '%/gallery/7.webp'
import image8 from '%/gallery/8.webp'
import image9 from '%/gallery/9.webp'
...
const SlideButton: React.FC<SlideButtonProps> = ({position}) => {
  ...
  return (
    <button className={cn('sm:hidden group absolute top-[47%] z-10 bg-white rounded-smallest py-4 xl:py-3', isLeft ? 'left-5 pl-5 pr-6' : 'right-5 pr-5 pl-6')} onClick={handleClick} title="slide">
...
export default function Gallery() {
  return (
    <Swiper
      ...
      grabCursor={true}
      loop={true}
      className="mySwiper relative h-[65vh] sm:h-[50vh] rounded-small"
